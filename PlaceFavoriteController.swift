...
class PlaceFavoriteController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        savedFavor = UserDefaults.standard.dictionary(forKey: "place")
        if savedFavor == nil {
            savedFavor = [:]
        }
//        print(savedID!) // test
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "PlaceFavorite") as! SearchTableViewCell
