...
class PageViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        savedID = UserDefaults.standard.array(forKey: "pageid") as? [String] // only read userDefault
        search(for: "q")
    }
    
    override func viewWillAppear(_ animated: Bool) {
        savedID = UserDefaults.standard.array(forKey: "pageid") as? [String]
...
//        print(SearchKeyword.keyword) // testing
        if keyword == "q" {
//            searchURL = "http://cs-server.usc.edu:11549/hw9/hw8.php?q=\(q)&type=page"
            searchURL = "http://myapp2017-env.us-west-2.elasticbeanstalk.com/hw9/hw9.php?q=\(q)&type=page"
        }
    ...
    func seeNext() {
        ...
        self.search(for: "next")
    }
    
    func seePrev() {
        print("paging previous...") // testing
        self.search(for: "prev")
    }
...
//        print("\(idArray.count)") // testing
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "PageTableViewCell") as! SearchTableViewCell
