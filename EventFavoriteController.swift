...
class EventFavoriteController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        savedFavor = UserDefaults.standard.dictionary(forKey: "event")
        if savedFavor == nil {
            savedFavor = [:]
        }
        showResult()
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "EventFavorite") as! SearchTableViewCell
