...
class GroupViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        savedID = UserDefaults.standard.array(forKey: "groupid") as? [String] // only read userDefault
        search(for: "q")
    }
...
//        print(SearchKeyword.keyword) // testing
        if keyword == "q" {
//            searchURL = "http://cs-server.usc.edu:11549/hw9/hw8.php?q=\(q)&type=group"
            searchURL = "http://myapp2017-env.us-west-2.elasticbeanstalk.com/hw9/hw9.php?q=\(q)&type=group"
        }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "GroupTableViewCell") as! SearchTableViewCell
