...
class EventViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        savedID = UserDefaults.standard.array(forKey: "eventid") as? [String] // only read userDefault
        search(for: "q")
    }
    
    override func viewWillAppear(_ animated: Bool) {
        savedID = UserDefaults.standard.array(forKey: "eventid") as? [String]
...
//        print(SearchKeyword.keyword) // testing
        if keyword == "q" {
//            searchURL = "http://cs-server.usc.edu:11549/hw9/hw8.php?q=\(q)&type=event"
            searchURL = "http://myapp2017-env.us-west-2.elasticbeanstalk.com/hw9/hw9.php?q=\(q)&type=event"
        }
...
//        print(nameArray) // testing
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "EventTableViewCell") as! SearchTableViewCell
